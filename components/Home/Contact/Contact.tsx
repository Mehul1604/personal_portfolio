            ...
            <div className='w-[90%] md:w-[80%] lg:w-[70%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10'>
                ...
                <div>
                    ...
                    <div className='flex items-center mt-8 space-x-3'>
                        ...
                        <div className='w-14 h-14 bg-blue-950/60 rounded-full flex items-center justify-center
                        cursor-pointer flex-col hover:bg-gray-200/40 transition-all duration-300'>
                            <FaGithub className='text-white w-6 h-6' />
                        </div>
                        <div className='w-14 h-14 bg-blue-950/60 rounded-full flex items-center justify-center
                        cursor-pointer flex-col hover:bg-blue-500 transition-all duration-300'>
                            <FaLinkedin className='text-white w-6 h-6' />
                        </div>
                        <div className='w-14 h-14 bg-blue-950/60 rounded-full flex items-center justify-center
                        cursor-pointer flex-col hover:bg-red-800 transition-all duration-300'>
                            <FaYoutube className='text-white w-6 h-6' />
                        </div>
                    </div>
                </div>
                {/* form */}
                <div className='m:p-10 p-5 bg-[#131332] rounded-lg'>
                    ...
                    <input type='email' placeholder='Email' className='px-4 py-3.5 mt-6 bg-[#363659] text-white 
                    outline-none rounded-md w-full placeholder:text-white/70'/>
                    <input type='text' placeholder='Mobile Number' className='px-4 py-3.5 mt-6 bg-[#363659] text-white 
                    outline-none rounded-md w-full placeholder:text-white/70'/>
                    <textarea placeholder='Your Message' className='px-4 py-3.5 mt-6 bg-[#363659] text-white 
